...
export default function Index() {
  return (
    <div className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-rose-100 to-teal-100 overflow-hidden">
      <Navbar />
      <div className="font-raleway, font-bold  z-10   text-3xl sm:w-60 md:text-6xl  md:w-full  mt-24 md:mt-44 drop-shadow-lg text-center mr-2 ">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-20  mb-20 ">
        <div className="flex flex-col md:flex-row items-center justify-center ">
          ...
          />
          <div className="font-raleway, font-bold   text-md md:text-xl lg:text-3xl   text-center md:text-left mt-4 w-60 md:w-1/3 justify-center md:ml-24 ">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mb-20 md:mb-40 ">
        <div className="font-raleway, font-bold text-md md:text-xl lg:text-3xl text-center md:text-left mt-4 w-60 md:w-1/3 justify-center md:mr-24  order-2 md:order-1 ">
