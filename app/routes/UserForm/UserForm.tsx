    ...
    return(
        <Form method="post" className="flex flex-col gap-4" {...props}>
            <div className="flex flex-col gap-2">
                <label htmlFor="email" className="mb-2 text slate-600">Email</label>
                <input
            ...
            <div className="flex flec-col gap-2">
                <label htmlFor="password" className="mb-2 text-slate-600">Password</label>
                <input defaultValue={fields?.password}
                type="password"
                name="password"
                className="p-4 border border-gray-200 rounded"
